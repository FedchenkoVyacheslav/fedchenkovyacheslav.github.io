let mySwiper1 = new Swiper ('.swiper-container-services', {
...
let mySwiper2 = new Swiper ('.swiper-container-spa', {

  slidesPerView: 2,
  spaceBetween: 16,

  pagination: {
    el: '.swiper-pagination-spa',
    clickable: true,
    dynamicBullets: true,
  },
...
let modalWaxing = document.querySelector(".modal-waxing--js");
let serviseWaxingOpen = document.querySelector(".services-block__item--waxing-js");
let buttonWaxingClose = document.querySelector(".modal__close--js-waxing");

serviseWaxingOpen.onclick = () => modalWaxing.classList.remove("modal--close");
buttonWaxingClose.onclick = () => { modalWaxing.classList.add("modal--close"); serviseWaxingOpen.focus();}
window.addEventListener("keydown", function (event) {
	if (!modalWaxing.classList.contains("modal--close") && event.code === "Escape") {
		modalWaxing.classList.add("modal--close");
		serviseWaxingOpen.focus();
	}
});

let modalLash = document.querySelector(".modal-lash--js");
let serviseLashOpen = document.querySelector(".services-block__item--lash-js");
let buttonLashClose = document.querySelector(".modal__close--js-lash");

serviseLashOpen.onclick = () => modalLash.classList.remove("modal--close");
buttonLashClose.onclick = () => { modalLash.classList.add("modal--close"); serviseLashOpen.focus();}
window.addEventListener("keydown", function (event) {
	if (!modalLash.classList.contains("modal--close") && event.code === "Escape") {
		modalLash.classList.add("modal--close");
		serviseLashOpen.focus();
	}
});

let modalMakeUp = document.querySelector(".modal-makeup--js");
let serviseMakeUpOpen = document.querySelector(".services-block__item--makeup-js");
let buttonMakeUpClose = document.querySelector(".modal__close--js-makeup");

serviseMakeUpOpen.onclick = () => modalMakeUp.classList.remove("modal--close");
buttonMakeUpClose.onclick = () => { modalMakeUp.classList.add("modal--close"); serviseMakeUpOpen.focus();}
window.addEventListener("keydown", function (event) {
	if (!modalMakeUp.classList.contains("modal--close") && event.code === "Escape") {
		modalMakeUp.classList.add("modal--close");
		serviseMakeUpOpen.focus();
	}
});

let modalMeet = document.querySelector(".modal-meet--js");
let windowMeetOpen = document.querySelector(".about-us__link--js");
let buttonMeetClose = document.querySelector(".modal__close--js-meet");

windowMeetOpen.onclick = () => modalMeet.classList.remove("modal--close");
buttonMeetClose.onclick = () => { modalMeet.classList.add("modal--close"); windowMeetOpen.focus(); }
window.addEventListener("keydown", function (event) {
	if (!modalMeet.classList.contains("modal--close") && event.code === "Escape") {
		modalMeet.classList.add("modal--close");
		windowMeetOpen.focus();
	}
});
